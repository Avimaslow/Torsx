...
struct SellersFAQView: View {
    ...
    @State private var isExpanded10 = false
    ...
    var body: some View {
        List {
            ...
            DisclosureGroup(isExpanded: $isExpanded1) {
                ...
                Text("What do I need to facilitate the buying process so I do not miss out on a great deal?")
            }
            ...
            DisclosureGroup(isExpanded: $isExpanded2) {
                ...
                Text("What is the importance of a credit check and how does it fit into the buying process?")
            }
            ...
            DisclosureGroup(isExpanded: $isExpanded3) {
                ...
                Text("What does being pre-qualified mean?")
            }
            ...
            DisclosureGroup(isExpanded: $isExpanded4) {
                ...
                Text("Why select a real estate attorney?")
            }
            ...
            DisclosureGroup(isExpanded: $isExpanded6) {
                ...
                Text("What are the steps in the application process?")
            }
            ...
            DisclosureGroup(isExpanded: $isExpanded8) {
                ...
                Text("What is the best way to win over sellers?")
            }
            ...
            DisclosureGroup(isExpanded: $isExpanded9) {
                ...
                Text("How do I make the deal happen?")
            }
        }
        .navigationTitle("Seller's FAQ")
