...
struct BuyersGuideFAQView: View {
    var body: some View {
        List {
            // Question 1
            DisclosureGroup("What do I need to facilitate the buying process so I do not miss out on a great deal?") {
                Text("""
            ...
            // Question 6
            DisclosureGroup("What are the steps in the application process?") {
                Text("""
